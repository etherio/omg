<template>
  <v-container>
    <h1>Privacy Policy for OMG Admin</h1>
    <p>
      At <b>omg.etherio.net</b>, accessible from
      <a href="https://omg.etherio.net" target="_blank"
        >https://omg.etherio.net</a
      >, one of our main priorities is the privacy of our visitors. This Privacy
      Policy document contains types of information that is collected and
      recorded by <b>omg.etherio.net</b> and how we use it.
    </p>
    <p>
    ...
    <p>
      ...
      and/or collect in <b>omg.etherio.net</b>. This policy is not applicable to
    ...
    <h2>Log Files</h2>
    <p>
      <b>omg.etherio.net</b> follows a standard procedure of using log files.
    ...
    <p>
      Like any other website, <b>omg.etherio.net</b> uses 'cookies'. These
    ...
    <p>
      ...
      advertising partners of <b>omg.etherio.net</b>.
    </p>
    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on <b>omg.etherio.net</b>, which are
    ...
    <p>
      Note that <b>omg.etherio.net</b> has no access to or control over these
      cookies that are used by third-party advertisers.
    </p>
    <v-divider class="my-5"></v-divider>
    <h2>Third Party Privacy Policies</h2>
    <p>
      <b>omg.etherio.net</b>'s Privacy Policy does not apply to other
    ...
    <p>
      <b>omg.etherio.net</b> does not knowingly collect any Personal
